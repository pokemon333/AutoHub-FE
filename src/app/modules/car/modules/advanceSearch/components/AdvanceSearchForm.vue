<template>
    <div class="pt-4 pb-4  lg:h-full lg:px-14 md:pl-20 md:pr-32  h-[75%] overflow-y-auto ">
        ...
        <div class=" w-1/2">
            <select  name="type" class="w-full border bg-slate-300 mt-2  border-primary-100   peer h-10 rounded-md px-3">
        ...
        <div class="mt-4">
            ...
            <div class="mt-2">
                ...
                <div class=" py-2 space-y-2" v-if="brandDropDown">
                    <div class="px-2 flex space-x-2" v-for="(brand,index) in brands" :key="index">
                        <input type="checkbox" :value="brand?.name" v-model="checkedBrand[index]" @change="filterModel">
                        <h1>{{ brand?.name }}</h1>
                    </div>
                </div>
           </div>
        ...
        <div class="mt-4">
            ...
            <div class="mt-2">
                ...
                <div class=" py-2 space-y-2" v-if="brandDropDown">
                    <div class="px-2 flex space-x-2" v-for="(brand,index) in 10" :key="index">
                        <input type="checkbox" >
                        <h1>{{ brand }}</h1>
                    </div>
                </div>
...
let checkedBrand = ref(Array(brands.value.length).fill(''));
...
let filterModel = () => {
    console.log(checkedBrand.value)
}
